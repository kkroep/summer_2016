...
\draw (-4.5,0.25) node[anchor=south]{$set$} (-4.5,0.25) node[]{} to (-4.5,0)to (-4.5,0); % IN[8]
\draw (0.5,-1.75) node[anchor=south]{$reset$} (0.5,-1.75) node[]{} to (0.5,-2)to (0,-2); % Rst[3]
\draw  (0,-5) to[R=$50\,k\Omega$](1.5,-5) to (1.5,-4.75) node[]{} (1.5,-4.75) node[anchor=south]{$5\,V$}; %res
