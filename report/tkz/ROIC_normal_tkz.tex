...
\newcommand*{\Vg}{Vg\\ $\color{red}2.5\,V$}
\newcommand*{\Rst}{\textbf{Rst[3]}\\ $\color{red}0\,V$} 
\newcommand*{\Res}{Res\\ $\color{red}0.86\,V$}
\newcommand*{\VDD}{VDD3.3\\ $\color{red}3.3\,V$}
\newcommand*{\IN}{\color{green}\textbf{IN[8]}}
\newcommand*{\OUT}{\color{red}\textbf{OUT[8]} $\color{red}1.4\,V$}
