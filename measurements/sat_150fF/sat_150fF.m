...
title('slope on varying input currents, C=150fF. test on line 106');
print('-deps', '-color', fullfile(pwd, '../../report/fig/sat_150fF.eps'))
...
print('-deps', '-color', '../../report/fig/vin_vs_time_sat_150fF.eps');
